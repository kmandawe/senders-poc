...
public class RedisQueueConfiguration {
     ...
     */
    public RedisQueueConfiguration() {
        this(new RedisquesConfigurationBuilder());
    }

    public RedisQueueConfiguration(String address, String configurationUpdatedAddress, String redisPrefix, String processorAddress, int refreshPeriod,
    ...
    public RedisQueueConfiguration(String address, String configurationUpdatedAddress, String redisPrefix, String processorAddress, int refreshPeriod,
        ...
        Logger log = LoggerFactory.getLogger(RedisQueueConfiguration.class);
    ...
    private RedisQueueConfiguration(RedisquesConfigurationBuilder builder) {
    ...
    public static RedisQueueConfiguration fromJsonObject(JsonObject json) {
        RedisquesConfigurationBuilder builder = RedisQueueConfiguration.with();
     ...
     * This value is half of {@link RedisQueueConfiguration#getCheckInterval()} in ms plus an additional 500ms.
     *
    ...
    public static class RedisquesConfigurationBuilder {
        ...
        public RedisQueueConfiguration build() {
            return new RedisQueueConfiguration(this);
        }
    }
